...
<a href="#" class="header_text"><p id="header-text" class="text-muted">Let's<span style="color:green;"> CHat</span></p></a>
</span>
</div>
...
<div class="mycontainer">
    ...
    <input type="button"  name="send_message" value="" id="btn_Send"/>
</form>
